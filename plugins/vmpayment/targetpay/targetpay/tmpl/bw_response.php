...
<div class="bankwire-info">
    <p><?= JText::sprintf('VMPAYMENT_TARGETPAY_BANKWIRE_RESPONSE_TEXT_1', $viewData['total'], $iban, $beneficiary)?></p>
    <p><?= JText::sprintf('VMPAYMENT_TARGETPAY_BANKWIRE_RESPONSE_TEXT_2',$trxid, $viewData['billing_email'])?></p>
    <p><?= JText::sprintf('VMPAYMENT_TARGETPAY_BANKWIRE_RESPONSE_TEXT_3',$bic, $bank)?></p>
    <p><i><?= JText::_('VMPAYMENT_TARGETPAY_BANKWIRE_RESPONSE_TEXT_4')?></i></p>
</div>
